    ...
    <div class="row p-3 shadow box-area" style="width: 700px;">
        <div class="col-md-12">
            <div class="row align-items-center">
                <form id="editUser" action="editUser" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <label class="label">
                        <input id="name" name="name" type="text" placeholder=" " maxlength="20" class="input input-group mb-4 fs-6" value="${user.name}" required>
                        <span class="labelName fs-6">Nombre</span>
                    </label>
                    <label class="label">
                        <input id="paternalName" name="paternalName" type="text" placeholder=" " maxlength="20" class="input input-group mb-4 fs-6" value="${user.paternalSurname}" required>
                        <span class="labelName fs-6">Apellido paterno</span>
                    </label>
                    <label class="label">
                        <input id="maternalName" name="maternalName" type="text" placeholder=" " maxlength="20" class="input input-group mb-4 fs-6" value="${user.maternalSurname}" required>
